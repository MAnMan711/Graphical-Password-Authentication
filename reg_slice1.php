		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form ">
					...
					<img class="im" src=<?php echo $var; ?> onload="changeIt(this)" height="100" width="100">
				<p class="account">Select the part you want to set as the image part.</p>
 ...
 <footer class="footer-distributed" style="height:300px">
  ...
  <div class="footer-right">
        <div>
          ...
          <p style="color:#fff" ><span>Garden@ One south  Serdang </span> Selangor, Country</p>
        </div>
</div>
